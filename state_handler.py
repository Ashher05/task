...
RDS_HOST = 'terraform-terraform-20241229181629346800000001.cx0magceipet.ap-south-1.rds.amazonaws.com'
RDS_USER = 'admin'
RDS_PASSWORD = 'ashher1234'
RDS_PORT = 3306  # For MySQL, default port is 3306

# S3 Bucket and File Key (path to the CSV file)
S3_BUCKET = 'ashhersstestbucket'
S3_FILE_KEY = 'sample-csv-files-sample4.csv'
